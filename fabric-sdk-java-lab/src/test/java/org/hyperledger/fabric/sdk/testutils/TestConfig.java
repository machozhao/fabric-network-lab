...
public class TestConfig {
    ...
    public String getTestChannelPath() {
        //return "src/test/fixture/sdkintegration/e2e-2Orgs/channel";
    	    return "/Users/zhaodonglu/Documents/Workspaces/workspace.blockchain/fabric-java-app-framework/cc-sample-microservice/src/test/fixture/sdkintegration/e2e-3Orgs/channel";
    }
...
//                    DEFAULT_CONFIG));
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                if (runningFabricCATLS) {
                    String cert = getTestChannelPath() + "/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem".replaceAll("DNAME", domainName);
